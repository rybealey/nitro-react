        ...
        <div className="phone-screen phone-camera">
            { inRoom && !capturedUrl &&
                <>
                    ...
                    { /* Orientation, inside the viewfinder's own corner, because
                         that is the thing it changes the shape of. How the phone
                         is HELD is not a kind of capture, so it is a control of
                         its own rather than an entry in the mode row. */ }
