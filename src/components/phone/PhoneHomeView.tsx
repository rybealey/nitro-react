...
export const APP_DEFS: Record<string, PhoneAppDef> = {
    ...
    'Spotify': { icon: 'waveform-lines', active: true, plate: 'linear-gradient(160deg, #1f1f1f, #121212 60%, #0a0a0a)', pri: '#2bd66a', sec: '#2bd66a' },
    ...
    // nothing else does.
    'Support': { icon: 'headset', active: true, plate: 'linear-gradient(160deg, #7b8cff, #4c5fe0 55%, #2f3db8)', sec: '#d7dcff' },
