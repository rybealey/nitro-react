...
export const USERNAME_COLORS: UsernameColor[] = [
    ...
    { key: 'rose', name: 'Rose', color: '#9f1239' },
    { key: 'maroon', name: 'Maroon', color: '#7f1d1d' },
    { key: 'orange', name: 'Orange', color: '#d35400' },
    { key: 'rust', name: 'Rust', color: '#9a3412' },
    { key: 'copper', name: 'Copper', color: '#a0522d' },
    { key: 'amber', name: 'Amber', color: '#b45309' },
    { key: 'gold', name: 'Gold', color: '#a16207' },
    { key: 'olive', name: 'Olive', color: '#4d7c0f' },
    { key: 'moss', name: 'Moss', color: '#3f6212' },
    { key: 'green', name: 'Green', color: '#2e7d32' },
    { key: 'forest', name: 'Forest', color: '#166534' },
    { key: 'emerald', name: 'Emerald', color: '#047857' },
